# This script will search the file 'Cluster_IDs.txt' with input from user for a specific gene cluster, and will output the gene evm model IDs of genes within that cluster. 
